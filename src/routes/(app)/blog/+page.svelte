		...
		>
			...
			<div class="flex flex-wrap items-center flex-1 px-4 py-1 text-center mx-auto">
				<a href="#" class="hover:underline">
					<h2 class="text-2xl font-bold tracking-normal text-gray-800">Ho to Yawn in 7 Days</h2>
				</a>
			</div>
			<hr class="border-gray-300" />
			<p
			...
			>
				...
				necessitatibus aut nesciunt exercitationem aliquam id voluptatibus quisquam maiores officia
